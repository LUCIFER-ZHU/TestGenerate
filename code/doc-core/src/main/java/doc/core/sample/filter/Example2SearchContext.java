...
public class Example2SearchContext extends QueryWrapperContext<Example2> {
    ...
    @JsonProperty("n_example2id_eq")
    @JSONField(name = "n_example2id_eq")
    @ApiModelProperty("示例明细标识EQ")
	private String example2IdEQ;
	public Example2SearchContext setExample2IdEQ(String example2IdEQ) {
        this.example2IdEQ = example2IdEQ;
        if(!ObjectUtils.isEmpty(this.example2IdEQ)){
