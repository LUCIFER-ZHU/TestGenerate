...
public interface ImpExpDataMapper extends BaseMapper<ImpExpData> {
    ...
    ImpExpData selectEntity(ImpExpData entity);

    List<ImpExpData> selectEntities(@Param("list") List<ImpExpData> list);

    @Override
    int insert(ImpExpData entity);

    @Override
    int updateById(@Param(Constants.ENTITY) ImpExpData entity);

    @Override
    int update(@Param(Constants.ENTITY) ImpExpData entity, @Param("ew") Wrapper<ImpExpData> updateWrapper);
    ...
    */
    ...
    List<ImpExpData> selectByCustomerId(@Param("customerId") Serializable customerId);
