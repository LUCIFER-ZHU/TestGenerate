...
public class KanbanDataSearchContext extends QueryWrapperContext<KanbanData> {
	...
	private String kanbanDataIdEQ;
	public KanbanDataSearchContext setKanbanDataIdEQ(String kanbanDataIdEQ) {
        this.kanbanDataIdEQ = kanbanDataIdEQ;
        if(!ObjectUtils.isEmpty(this.kanbanDataIdEQ)){
