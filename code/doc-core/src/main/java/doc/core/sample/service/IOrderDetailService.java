...
import doc.core.sample.filter.OrderDetailSearchContext;
...
public interface IOrderDetailService extends IService<OrderDetail> {
    ...
    boolean saveByOrderId(doc.core.sample.domain.Order order,List<OrderDetail> list);
    default boolean saveByOrderId(String orderId,List<OrderDetail> list) {
        return saveByOrderId(new doc.core.sample.domain.Order().setOrderId(orderId),list);
    }
    ...
    boolean saveByProductId(doc.core.sample.domain.Product product,List<OrderDetail> list);
    default boolean saveByProductId(String productId,List<OrderDetail> list) {
        return saveByProductId(new doc.core.sample.domain.Product().setProductId(productId),list);
    }
