...
public interface IEditorValueService extends IService<EditorValue> {
    ...
    boolean saveByCustomerId(doc.core.sample.domain.Customer customer,List<EditorValue> list);
    ...
    boolean saveByCustomerid2(doc.core.sample.domain.Customer customer,List<EditorValue> list);
    default boolean saveByCustomerid2(String customerid2,List<EditorValue> list) {
        return saveByCustomerid2(new doc.core.sample.domain.Customer().setCustomerId(customerid2),list);
    }
    ...
    boolean saveByCustomerid3(doc.core.sample.domain.Customer customer,List<EditorValue> list);
    default boolean saveByCustomerid3(String customerid3,List<EditorValue> list) {
        return saveByCustomerid3(new doc.core.sample.domain.Customer().setCustomerId(customerid3),list);
    }
    ...
    boolean saveByCustomerid4(doc.core.sample.domain.Customer customer,List<EditorValue> list);
    default boolean saveByCustomerid4(String customerid4,List<EditorValue> list) {
        return saveByCustomerid4(new doc.core.sample.domain.Customer().setCustomerId(customerid4),list);
    }
    ...
    boolean saveByCustomerid5(doc.core.sample.domain.Customer customer,List<EditorValue> list);
    default boolean saveByCustomerid5(String customerid5,List<EditorValue> list) {
        return saveByCustomerid5(new doc.core.sample.domain.Customer().setCustomerId(customerid5),list);
    }
