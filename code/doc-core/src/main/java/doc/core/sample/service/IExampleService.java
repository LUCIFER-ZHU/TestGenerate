...
public interface IExampleService extends IService<Example> {
    ...
    boolean saveByCityId(doc.core.sample.domain.City city,List<Example> list);
    ...
    boolean saveByDistrictId(doc.core.sample.domain.District district,List<Example> list);
    ...
    boolean saveByProvinceId(doc.core.sample.domain.Province province,List<Example> list);
