...
public interface IOrgDataService extends IService<OrgData> {
    ...
    boolean saveByPorgdataid(doc.core.sample.domain.OrgData orgData,List<OrgData> list);
    default boolean saveByPorgdataid(String porgdataid,List<OrgData> list) {
        return saveByPorgdataid(new doc.core.sample.domain.OrgData().setOrgDataId(porgdataid),list);
    }
