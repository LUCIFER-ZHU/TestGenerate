...
public interface ICategoryService extends IService<Category> {
    ...
    boolean saveByPcategoryid(doc.core.sample.domain.Category category,List<Category> list);
    default boolean saveByPcategoryid(String pcategoryid,List<Category> list) {
        return saveByPcategoryid(new doc.core.sample.domain.Category().setCategoryId(pcategoryid),list);
    }
