...
public interface ICustomerService extends IService<Customer> {
    ...
    boolean saveByCityId(doc.core.sample.domain.City city,List<Customer> list);
    ...
    boolean saveByPcustomerid(doc.core.sample.domain.Customer customer,List<Customer> list);
    default boolean saveByPcustomerid(String pcustomerid,List<Customer> list) {
        return saveByPcustomerid(new doc.core.sample.domain.Customer().setCustomerId(pcustomerid),list);
    }
    ...
    boolean saveByDistrictId(doc.core.sample.domain.District district,List<Customer> list);
    default boolean saveByDistrictId(String districtId,List<Customer> list) {
        return saveByDistrictId(new doc.core.sample.domain.District().setDistrictId(districtId),list);
    }
    ...
    boolean saveByProvinceId(doc.core.sample.domain.Province province,List<Customer> list);
    default boolean saveByProvinceId(String provinceId,List<Customer> list) {
        return saveByProvinceId(new doc.core.sample.domain.Province().setProvinceId(provinceId),list);
    }
