...
public interface IExample2Service extends IService<Example2> {
    ...
    boolean saveByExampleId(doc.core.sample.domain.Example example,List<Example2> list);
    default boolean saveByExampleId(String exampleId,List<Example2> list) {
        return saveByExampleId(new doc.core.sample.domain.Example().setExampleId(exampleId),list);
    }
