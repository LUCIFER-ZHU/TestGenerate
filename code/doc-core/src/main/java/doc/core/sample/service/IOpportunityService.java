...
public interface IOpportunityService extends IService<Opportunity> {
    ...
    boolean saveByCustomerId(doc.core.sample.domain.Customer customer,List<Opportunity> list);
    ...
    boolean saveByPersonDataId(doc.core.sample.domain.PersonData personData,List<Opportunity> list);
    default boolean saveByPersonDataId(String personDataId,List<Opportunity> list) {
        return saveByPersonDataId(new doc.core.sample.domain.PersonData().setPersonDataId(personDataId),list);
    }
