...
public interface IProductCategoryService extends IService<ProductCategory> {
    ...
    boolean saveByCategoryId(doc.core.sample.domain.Category category,List<ProductCategory> list);
    default boolean saveByCategoryId(String categoryId,List<ProductCategory> list) {
        return saveByCategoryId(new doc.core.sample.domain.Category().setCategoryId(categoryId),list);
    }
    ...
    boolean saveByProductId(doc.core.sample.domain.Product product,List<ProductCategory> list);
