    ...
    public void run(ApplicationArguments args) {
        try {
            ...
            if (!ObjectUtils.isEmpty(permission)) {
                ...
                system.put("pssystemid", StringUtils.isEmpty(systemId)?"doc":systemId);
        ...
        try {
            InputStream model = this.getClass().getResourceAsStream("/sysmodel/doc.json"); //系统模型
