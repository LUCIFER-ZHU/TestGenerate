...
/**
 * 服务DTO对象[LogicValidDataSimpleDTO]
 */
@Getter
@Setter
@NoArgsConstructor
...
public class LogicValidDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [标识]
     */
    public LogicValidDataSimpleDTO setCode(String code) {
        this.code = code;
     ...
     * 设置 [名称]
     */
    public LogicValidDataSimpleDTO setLogicValidDataName(String logicValidDataName) {
     ...
     * 设置 [区域]
     */
    public LogicValidDataSimpleDTO setRegion(String region) {
        this.region = region;
