...
@ApiModel("部门数据")
public class DeptDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [部门名称]
     */
    public DeptDataSimpleDTO setDeptDataName(String deptDataName) {
