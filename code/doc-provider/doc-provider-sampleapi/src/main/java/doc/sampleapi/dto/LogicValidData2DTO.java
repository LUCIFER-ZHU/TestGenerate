...
public class LogicValidData2DTO extends DTOBase implements Serializable {
     ...
     * 设置 [标识]
     */
    public LogicValidData2DTO setCode(String code) {
        this.code = code;
     ...
     * 设置 [名称]
     */
    public LogicValidData2DTO setLogicValidData2Name(String logicValidData2Name) {
     ...
     * 设置 [区域]
     */
    public LogicValidData2DTO setRegion(String region) {
        this.region = region;
     ...
     * 设置 [唯一标识]
     */
    public LogicValidData2DTO setUnionkey(String unionkey) {
