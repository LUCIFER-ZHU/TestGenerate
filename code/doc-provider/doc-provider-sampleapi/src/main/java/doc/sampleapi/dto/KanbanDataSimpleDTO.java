...
@ApiModel("看板数据")
public class KanbanDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [任务名称]
     */
    public KanbanDataSimpleDTO setKanbanDataName(String kanbanDataName) {
