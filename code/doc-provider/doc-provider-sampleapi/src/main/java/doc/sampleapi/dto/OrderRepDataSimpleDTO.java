...
@ApiModel("订单报表数据")
public class OrderRepDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [订单报表数据名称]
     */
    public OrderRepDataSimpleDTO setOrderRepDataName(String orderRepDataName) {
