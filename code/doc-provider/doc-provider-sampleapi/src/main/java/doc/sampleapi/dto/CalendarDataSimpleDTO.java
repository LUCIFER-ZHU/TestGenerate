...
@ApiModel("日历示例数据")
public class CalendarDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [事项]
     */
    public CalendarDataSimpleDTO setCalendarDataName(String calendarDataName) {
