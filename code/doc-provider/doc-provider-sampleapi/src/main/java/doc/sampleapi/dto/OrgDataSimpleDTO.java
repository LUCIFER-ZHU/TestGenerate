...
@ApiModel("组织数据")
public class OrgDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [组织名称]
     */
    public OrgDataSimpleDTO setOrgDataName(String orgDataName) {
