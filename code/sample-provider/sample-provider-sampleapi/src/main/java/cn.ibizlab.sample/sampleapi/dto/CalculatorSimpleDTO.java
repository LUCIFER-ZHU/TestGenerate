...
@ApiModel("计算器")
public class CalculatorSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [计算器名称]
     */
    public CalculatorSimpleDTO setCalculatorName(String calculatorName) {
