...
@ApiModel("地图示例数据")
public class MapDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [名称]
     */
    public MapDataSimpleDTO setMapDataName(String mapDataName) {
