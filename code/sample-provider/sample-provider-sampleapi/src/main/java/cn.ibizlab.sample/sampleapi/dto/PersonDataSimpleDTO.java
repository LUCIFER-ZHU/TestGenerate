...
@ApiModel("人员数据")
public class PersonDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [姓名]
     */
    public PersonDataSimpleDTO setPersonDataName(String personDataName) {
