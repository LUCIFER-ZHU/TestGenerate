...
@ApiModel("向导数据")
public class WizardDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [向导数据名称]
     */
    public WizardDataSimpleDTO setWizardDataName(String wizardDataName) {
