...
@ApiModel("计数器数据")
public class CounterDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [计数器数据名称]
     */
    public CounterDataSimpleDTO setCounterDataName(String counterDataName) {
