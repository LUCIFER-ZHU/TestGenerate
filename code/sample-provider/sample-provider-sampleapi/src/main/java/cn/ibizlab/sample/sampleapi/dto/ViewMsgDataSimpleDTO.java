...
@ApiModel("视图消息数据")
public class ViewMsgDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [视图消息标题]
     */
    public ViewMsgDataSimpleDTO setViewMsgDataName(String viewMsgDataName) {
