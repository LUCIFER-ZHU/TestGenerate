...
@ApiModel("示例明细")
public class Example2SimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [示例明细名称]
     */
    public Example2SimpleDTO setExample2Name(String example2Name) {
