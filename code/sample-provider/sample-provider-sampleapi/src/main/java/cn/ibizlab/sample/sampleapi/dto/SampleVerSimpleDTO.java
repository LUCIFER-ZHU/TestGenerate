...
@ApiModel("示例版本")
public class SampleVerSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [标题]
     */
    public SampleVerSimpleDTO setSampleVerName(String sampleVerName) {
