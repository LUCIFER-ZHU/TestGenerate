...
@ApiModel("部门数据")
public class DeptDataDTO extends DTOBase implements Serializable {
     ...
     * 设置 [部门名称]
     */
    public DeptDataDTO setDeptDataName(String deptDataName) {
     ...
     * 设置 [组织数据标识]
     */
    public DeptDataDTO setOrgDataId(String orgDataId) {
     ...
     * 设置 [组织名称]
     */
    public DeptDataDTO setOrgDataName(String orgDataName) {
