...
@ApiModel("图表")
public class ChartDataSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [图表名称]
     */
    public ChartDataSimpleDTO setChartDataName(String chartDataName) {
