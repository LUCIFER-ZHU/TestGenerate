...
@ApiModel("订单明细")
public class OrderDetailSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [订单明细名称]
     */
    public OrderDetailSimpleDTO setOrderDetailName(String orderDetailName) {
