...
/**
 * 服务DTO对象[DynaDashboardSimpleDTO]
 */
@Getter
@Setter
@NoArgsConstructor
...
@ApiModel("动态数据看板")
public class DynaDashboardSimpleDTO extends DTOBase implements Serializable {
     ...
     * 设置 [动态数据看板名称]
     */
    public DynaDashboardSimpleDTO setDynaDashboardName(String dynaDashboardName) {
