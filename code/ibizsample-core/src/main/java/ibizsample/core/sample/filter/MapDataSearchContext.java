...
public class MapDataSearchContext extends QueryWrapperContext<MapData> {
    ...
    @JsonProperty("n_mapdataid_eq")
    @JSONField(name = "n_mapdataid_eq")
    @ApiModelProperty("地图示例数据标识EQ")
	private String mapDataIdEQ;
	public MapDataSearchContext setMapDataIdEQ(String mapDataIdEQ) {
        this.mapDataIdEQ = mapDataIdEQ;
        if(!ObjectUtils.isEmpty(this.mapDataIdEQ)){
