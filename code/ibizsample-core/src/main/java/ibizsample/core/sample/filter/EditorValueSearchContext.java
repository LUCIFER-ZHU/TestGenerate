...
public class EditorValueSearchContext extends QueryWrapperContext<EditorValue> {
    ...
    @JsonProperty("n_editorvalueid_eq")
    @JSONField(name = "n_editorvalueid_eq")
    @ApiModelProperty("编辑器值标识EQ")
	private String editorValueIdEQ;
	public EditorValueSearchContext setEditorValueIdEQ(String editorValueIdEQ) {
        this.editorValueIdEQ = editorValueIdEQ;
        if(!ObjectUtils.isEmpty(this.editorValueIdEQ)){
