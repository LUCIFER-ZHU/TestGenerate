...
public class OrderDetailSearchContext extends QueryWrapperContext<OrderDetail> {
	...
	private String orderDetailIdEQ;
	public OrderDetailSearchContext setOrderDetailIdEQ(String orderDetailIdEQ) {
        this.orderDetailIdEQ = orderDetailIdEQ;
        if(!ObjectUtils.isEmpty(this.orderDetailIdEQ)){
