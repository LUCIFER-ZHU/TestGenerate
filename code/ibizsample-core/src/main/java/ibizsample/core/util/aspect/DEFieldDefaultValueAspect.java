package ibizsample.core.util.aspect;
...
public class DEFieldDefaultValueAspect
{
     ...
     * @throws Exception
     */
    @Before(value = "execution(* ibizsample.core.*.service.*.create(..))")
    public void BeforeCreate(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* ibizsample.core.*.service.*.createBatch(..))")
     ...
     * @throws Exception
     */
    @Before(value = "execution(* ibizsample.core.*.service.*.update(..))")
    public void BeforeUpdate(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* ibizsample.core.*.service.*.updateBatch(..))")
     ...
     * @throws Exception
     */
    @Before(value = "execution(* ibizsample.core.*.service.*.save(..))")
    public void BeforeSave(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* ibizsample.core.*.service.*.saveBatch(..))")
