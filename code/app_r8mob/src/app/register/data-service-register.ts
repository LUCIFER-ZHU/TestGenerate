...
export class DataServiceRegister implements IDataServiceRegister {
    ...
    protected init(): void {
        ...
        DataServiceRegister.allDataServiceMap.set('counterdata', () => import('@api/counter-data/counter-data-service'));
        ...
        DataServiceRegister.allDataServiceMap.set('event', () => import('@api/event/event-service'));
