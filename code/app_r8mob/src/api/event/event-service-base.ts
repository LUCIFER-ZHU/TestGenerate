...
export class EventServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of EventServiceBase.
  *
  * @param {*} [opts={}]
  ...
  */
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'event';
    this.appEntityCodeNames = 'events';
    this.appEntityKeyCodeName = 'eventid';
      this.appEntityTextCodeName = 'eventname';
    // 初始化关系实体路径集合
    this.deResPaths = [
