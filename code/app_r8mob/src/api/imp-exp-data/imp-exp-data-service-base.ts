...
export class ImpExpDataServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of ImpExpDataServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof ImpExpDataServiceBase
  */
  constructor(opts: IParam = {}) {
      super(opts,'ImpExpData');
  }
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'impexpdata';
    this.appEntityCodeNames = 'impexpdatas';
    this.appEntityKeyCodeName = 'impexpdataid';
      this.appEntityTextCodeName = 'impexpdataname';
    // 初始化关系实体路径集合
    this.deResPaths = [
