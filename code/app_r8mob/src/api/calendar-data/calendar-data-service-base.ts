...
export class CalendarDataServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of CalendarDataServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof CalendarDataServiceBase
  */
  constructor(opts: IParam = {}) {
      super(opts,'CalendarData');
  }
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'calendardata';
    this.appEntityCodeNames = 'calendardatas';
    this.appEntityKeyCodeName = 'calendardataid';
      this.appEntityTextCodeName = 'calendardataname';
    // 初始化关系实体路径集合
    this.deResPaths = [
