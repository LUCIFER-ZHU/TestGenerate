...
export class CategoryServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of CategoryServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof CategoryServiceBase
  */
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'category';
    this.appEntityCodeNames = 'categories';
    this.appEntityKeyCodeName = 'categoryid';
      this.appEntityTextCodeName = 'categoryname';
    // 初始化关系实体路径集合
    this.deResPaths = [
   ...
   * @memberof CategoryServiceBase
   */
  public async FetchRoot(context: IContext = {}, data: IParam = {}): Promise<any> {
    const deResPath = this.buildDeResPath(context, false);
    const res = await this.http.post(`${deResPath}/fetchroot`,data);
    return res;
  }
