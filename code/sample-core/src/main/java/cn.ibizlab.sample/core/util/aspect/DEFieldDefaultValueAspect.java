package cn.ibizlab.sample.core.util.aspect;
...
public class DEFieldDefaultValueAspect
{
     ...
     * @throws Exception
     */
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.create(..))")
    public void BeforeCreate(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.createBatch(..))")
     ...
     * @throws Exception
     */
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.update(..))")
    public void BeforeUpdate(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.updateBatch(..))")
     ...
     * @throws Exception
     */
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.save(..))")
    public void BeforeSave(JoinPoint point) throws Exception {
        fillDEFieldDefaultValue(point);
    }
    @Before(value = "execution(* cn.ibizlab.sample.core.*.service.*.saveBatch(..))")
