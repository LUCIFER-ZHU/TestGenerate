...
public class DELogicAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* cn.ibizlab.sample.core.*.service.*.*(..)) && !execution(* cn.ibizlab.sample.core.es.service.*.*(..))")
    ...
    static {
                    validLogic.add("examplecalcpfexec.bpmn");
                    validLogic.add("examplepreparectxexec.bpmn");
    }
