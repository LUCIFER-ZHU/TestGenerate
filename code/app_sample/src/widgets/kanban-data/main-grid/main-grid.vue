...
<div v-if="Object.is(column.dataIndex, 'kanbandataname')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'taskstatus')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'begintime')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'endtime')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'memo')" class="header-cell">
...
<div v-if="Object.is(column.dataIndex, 'kanbandataname')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'taskstatus')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'begintime')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'endtime')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'memo')" class="table-cell">
