...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.kanbandataname.visible" name="kanbandataname" label="任务名称">
<appInput
  name="kanbandataname"
  :maxLength="200"
  type="text"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.taskstatus.visible" name="taskstatus" label="任务状态">
<appDropdownList
  name="taskstatus"
