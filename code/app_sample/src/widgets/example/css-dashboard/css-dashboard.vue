...
import { ctrlState } from './css-dashboard-state';
import { DashboardControl, IActionParam, IParam, IContext } from '@core';

import { BaseDashboardView_CSSdashboard_rawitem1Portlet } from '@widgets/example/base-dashboard-view-cs-sdashboard-rawitem1-portlet';
...
<template>
  <div class="app-dashboard">
    <template v-if="!state.isEnableCustomized">
      <BaseDashboardView_CSSdashboard_rawitem1Portlet
        ref="portlet"
