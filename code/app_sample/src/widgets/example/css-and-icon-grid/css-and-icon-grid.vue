...
import { ctrlState } from './css-and-icon-grid-state';
    ...
    <a-form name="grid" class="app-grid-form"  >
      ...
      >
        ...
        <template #headerCell="{title, column}">
          <div v-if="Object.is(column.dataIndex, 'examplename')" class="header-cell gird-red-border">
              <AppIconText iconClass="fa fa-stethoscope" />
        ...
        <template #bodyCell="{ column, text, record, index }">
          <div v-if="Object.is(column.dataIndex, 'examplename')" class="table-cell gird-cell-brack">
            <div class="text-cell">
