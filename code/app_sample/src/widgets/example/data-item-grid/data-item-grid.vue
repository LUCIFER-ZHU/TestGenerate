...
import { ctrlState } from './data-item-grid-state';
    ...
    <a-form name="grid" class="app-grid-form"  >
      ...
      >
        ...
        <template #headerCell="{title, column}">
          <div v-if="Object.is(column.dataIndex, 'defgridcolumn')" class="header-cell">
        ...
        <template #bodyCell="{ column, text, record, index }">
          <div v-if="Object.is(column.dataIndex, 'defgridcolumn')" class="table-cell">
            <div class="text-cell">
