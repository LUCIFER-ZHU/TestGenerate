...
<template>
  <a-form name="Base" class="app-form" style="" :model="state.data" :rules="state.rules">
...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.formitemex1.visible"
    name="formitemex1"
...
<a-col
 ...
 >
  <a-button 
    ...
    style="">
      <span class="formgroup-bold-center">触发界面行为</span>
  </a-button>
</a-col>
<a-col
  :lg="{span: 24, offset: 0 }"
