...
<a-tab-pane v-show="state.detailsModel.formpage1.visible" key="formpage1" tab="表单分页">
  <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.formitem1.visible" name="formitem1" :rules="state.rules.formitem1" :required="state.detailsModel.formitem1.required" label="表单项">
<appInput
  name="formitem1"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.formitem3.visible" name="formitem3" :rules="state.rules.formitem3" :required="state.detailsModel.formitem3.required" label="表单项">
<appInput
  name="formitem3"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.formitemex1.visible" name="formitemex1" :rules="state.rules.formitemex1" :required="state.detailsModel.formitemex1.required" label="复合表单项">
<appDatePicker
  name="formitemex1"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <div v-show="state.detailsModel.iframe1.visible" class="app-form-iframe" style="height: 200.0px;">
    <iframe src="https://www.yuque.com/ibiz" style="height: 100%;width: 100%;border: 0"></iframe>
  </div>
</a-col>
<a-col
  :lg="{span: 24, offset: 0 }"
...
<a-tab-pane v-show="state.detailsModel.formpage2.visible" key="formpage2" tab="表单分页2">
  <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.formitem2.visible" name="formitem2" :rules="state.rules.formitem2" :required="state.detailsModel.formitem2.required" label="表单项">
<appInput
  name="formitem2"
