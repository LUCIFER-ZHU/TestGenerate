...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.activityname.visible" name="activityname" label="活动名称">
<appInput
  name="activityname"
  :maxLength="200"
  type="text"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.activitytype.visible" name="activitytype" label="活动类型">
<appDropdownList
  name="activitytype"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.begintime.visible" name="begintime" label="起始时间">
<appDatePicker
  name="begintime"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.description.visible" name="description" label="活动描述">
<appInput
  name="description"
  :maxLength="2000"
  :showMaxLength="true"
