...
<div v-if="Object.is(column.dataIndex, 'activityname')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'activitytype')" class="header-cell">
...
<div v-if="Object.is(column.dataIndex, 'activityname')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'activitytype')" class="table-cell">
