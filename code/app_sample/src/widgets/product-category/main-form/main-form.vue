...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.productcategoryname.visible" name="productcategoryname" :rules="state.rules.productcategoryname" :required="state.detailsModel.productcategoryname.required" label="产品类别名称">
<appInput
  name="productcategoryname"
  :disabled="state.detailsModel.productcategoryname.disabled"
  :maxLength="200"
  type="text"
  :value="state.data.productcategoryname"
