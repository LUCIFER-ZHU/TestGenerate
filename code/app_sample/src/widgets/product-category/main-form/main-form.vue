...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.productcategoryname.visible" name="productcategoryname" :required="state.detailsModel.productcategoryname.required" label="产品类别名称">
<appInput
