...
export class ControlVO extends ControlVOBase {
  ...
  constructor(data: any){
    super(data);
    // 记录没有映射的属性
    this.$ownKeys =['srfupdatedate','srforikey','srfkey','srfmajortext','srftempmode','srfuf','srfdeid','srfsourcekey','productcategoryname','createman','createdate','updateman','updatedate','productcategoryid'];  
  }
  ...
  set productcategoryname(value: any) {
    this.$DO.productcategoryname = value;
  }
  ...
  set productcategoryid(value: any) {
    this.$DO.productcategoryid = value;
  }
...
export const ctrlState = {
  ...
  controlName: 'form',
  controlService: new EditFormService<ControlVO>(ControlVO, new ProductCategoryService() ),
  data: new ControlVO({}),
