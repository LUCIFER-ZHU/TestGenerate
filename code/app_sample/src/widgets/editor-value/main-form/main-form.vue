...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.editorvaluename.visible" name="editorvaluename" :rules="state.rules.editorvaluename" :required="state.detailsModel.editorvaluename.required" label="编辑器值名称">
<appInput
  name="editorvaluename"
  :disabled="state.detailsModel.editorvaluename.disabled"
  :maxLength="200"
  type="text"
