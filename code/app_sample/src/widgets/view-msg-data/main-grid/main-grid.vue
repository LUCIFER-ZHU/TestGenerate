    ...
    <a-form name="grid" class="app-grid-form"  >
      ...
      >
        ...
        <template #headerCell="{title, column}">
          <div v-if="Object.is(column.dataIndex, 'viewmsgdataname')" class="header-cell">

              <span class="title">{{title}}</span>
            
          </div>
          <div v-if="Object.is(column.dataIndex, 'content')" class="header-cell">
          ...
          <div v-if="Object.is(column.dataIndex, 'location')" class="header-cell">
        ...
        <template #bodyCell="{ column, text, record, index }">
          <div v-if="Object.is(column.dataIndex, 'viewmsgdataname')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
              
            </div>
          </div>
          <div v-if="Object.is(column.dataIndex, 'content')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
          ...
          <div v-if="Object.is(column.dataIndex, 'location')" class="table-cell">
            <div class="text-cell">
              <AppCodelist
                name="location"
