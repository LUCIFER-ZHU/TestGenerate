export const ctrlState = {
  controlCodeName: 'TreeExpForChartViewtreeexpbar',
  ...
  viewRefs: [
    {
      name: 'EXPITEM:barChart',
      viewName: 'ChartDataBarChartView',
      deKeyField: 'ChartData',
    },
    {
      name: 'EXPITEM:mulChart',
      viewName: 'ChartDataUsr2ChartView',
      deKeyField: 'ChartData',
    },
    {
      name: 'EXPITEM:RingPie',
    ...
    {
      name: 'EXPITEM:lineChart',
      viewName: 'ChartDataLineChartView',
      deKeyField: 'ChartData',
    },
    {
      name: 'EXPITEM:AreaChart',
