...
import { ctrlState } from './usr2-pickup-viewpickupviewpanel-pickup-view-panel-state';
import ChartDataPickupTreeView from '@views/sample/chart-data-pickup-tree-view';
interface Props {
  name:string,
  context: IContext;
  viewParams?: IParam;
