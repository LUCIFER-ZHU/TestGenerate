...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.orgdataid.visible"
    name="orgdataid"
    :rules="state.rules.orgdataid"
    :labelWidth="130"
    :required="state.detailsModel.orgdataid.required"
    label="组织数据标识"
    style="">
      <div class="form-editor-container" style="">
      /*未找到模板[HIDDEN]*/      </div>
...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.deptdataid.visible"
    name="deptdataid"
    :rules="state.rules.deptdataid"
    :labelWidth="130"
    :required="state.detailsModel.deptdataid.required"
    label="部门数据标识"
    style="">
      <div class="form-editor-container" style="">
      /*未找到模板[HIDDEN]*/      </div>
