...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.categoryname.visible" name="categoryname" :rules="state.rules.categoryname" :required="state.detailsModel.categoryname.required" label="类别名称">
<appInput
  name="categoryname"
