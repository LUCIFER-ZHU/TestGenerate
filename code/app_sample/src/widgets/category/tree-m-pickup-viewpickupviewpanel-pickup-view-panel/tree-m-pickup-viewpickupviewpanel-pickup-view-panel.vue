...
import { ctrlState } from './tree-m-pickup-viewpickupviewpanel-pickup-view-panel-state';
import CategoryPickupTreeView from '@views/sample/category-pickup-tree-view';
interface Props {
  name:string,
  context: IContext;
  viewParams?: IParam;
