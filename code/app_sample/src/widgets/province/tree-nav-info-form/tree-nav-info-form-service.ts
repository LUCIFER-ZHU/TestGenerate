...
import { ProvinceService } from '@service/entity/province/province-service';
import { ControlVO } from './tree-nav-info-form-config';
...
export class ControlService extends ControlServiceBase {
   ...
   * 实体服务对象
   */
  public entityService: ProvinceService = new ProvinceService();
