...
import { ctrlState } from './mob-m-pickup-viewpickupviewpanel-pickup-view-panel-state';
import ProvinceMobPickupMDView from '@views/sample/province-mob-pickup-md-view';
interface Props {
  context: IContext;
  viewParams?: IParam;
