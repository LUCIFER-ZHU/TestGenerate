...
export class ControlVO extends ControlVOBase {
  ...
  constructor(data: any){
    super(data);
    // 记录没有映射的属性
    this.$ownKeys =['srfupdatedate','srforikey','srfkey','srfmajortext','srftempmode','srfuf','srfdeid','srfsourcekey','customerid','customername','monthval','quarterval','yearval','totalval','createman','createdate','updateman','updatedate','orderrepdataid'];  
  }
