...
<div v-if="Object.is(column.dataIndex, 'leaveapplicationname')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'state')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'step')" class="header-cell">
...
<div v-if="Object.is(column.dataIndex, 'ext_data')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'ext_param')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'ext_param2')" class="header-cell">
...
<div v-if="Object.is(column.dataIndex, 'leaveapplicationname')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'step')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'ext_data')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'ext_param')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'ext_param2')" class="table-cell">
