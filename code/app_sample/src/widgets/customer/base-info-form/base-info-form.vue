...
import { CtrlConfig } from './base-info-form-config';
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="group1" title="客户基本信息">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel2" title="头部">
    <a-row>
<a-col
  :lg="{span: 12, offset: 0 }"
  :md="{span: 12, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel7" title="头部左边">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem name="customername" label="">
<IbizSpan
  name="customername"
  dataType="25"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel8" title="头部右边">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem name="image" label="图像">
<IbizUpload
  name="image"
  :limit="1"
  accept='image/*'
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel3" title="中间">
    <a-row>
<a-col
  :lg="{span: 12, offset: 0 }"
  :md="{span: 12, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel6" title="地址">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
...
<a-col
 >
  <IbizFormItem name="provincename" label="公司地址">
<IbizSpan
  name="provincename"
  dataType="25"
...
<IbizSpan
  name="cityname"
  dataType="25"
  localParam="[net.ibizsys.model.control.PSNavigateParamImpl@6ff415ad]"
...
<IbizSpan
  name="districtname"
  dataType="25"
  localParam="[net.ibizsys.model.control.PSNavigateParamImpl@280d9edc]"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem name="street" label="">
<IbizSpan
  name="street"
  dataType="25"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem name="taxno" label="税号">
<IbizSpan
  name="taxno"
  dataType="25"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup name="grouppanel4" title="联系方式">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem name="website" label="网站地址">
<IbizSpan
  name="website"
  dataType="25"
