...
<template>
  <a-form name="BaseInfo" class="app-form app-info-form" style="" :model="state.data" :rules="state.rules">
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
  :sm="{span: 24, offset: 0 }"
...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.cityid.visible"
    name="cityid"
    :rules="state.rules.cityid"
    :labelWidth="130"
    :required="state.detailsModel.cityid.required"
    label="市标识"
    style="">
      <div class="form-editor-container" style="">
      /*未找到模板[HIDDEN]*/      </div>
...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.provinceid.visible"
    name="provinceid"
    :rules="state.rules.provinceid"
    :labelWidth="130"
    :required="state.detailsModel.provinceid.required"
    label="省份标识"
    style="">
      <div class="form-editor-container" style="">
      /*未找到模板[HIDDEN]*/      </div>
...
<a-col
 ...
 >
  <AppFormItem 
    v-show="state.detailsModel.districtid.visible"
    name="districtid"
    :rules="state.rules.districtid"
    :labelWidth="130"
    :required="state.detailsModel.districtid.required"
    label="区标识"
    style="">
      <div class="form-editor-container" style="">
      /*未找到模板[HIDDEN]*/      </div>
