...
import { ctrlState } from './main-tab-exp-viewtabviewpanel-tab-view-panel-state';
import CustomerMainDashboardView from '@views/sample/customer-main-dashboard-view';
interface Props {
  name:string,
  context: IContext;
  viewParams?: IParam;
