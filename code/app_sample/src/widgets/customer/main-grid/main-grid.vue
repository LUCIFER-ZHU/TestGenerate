...
<div v-if="Object.is(column.dataIndex, 'pcustomername')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'phone')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'mobile')" class="header-cell">

    <span class="title">{{title}}</span>
  
</div>
<div v-if="Object.is(column.dataIndex, 'email')" class="header-cell">
...
<div v-if="Object.is(column.dataIndex, 'pcustomername')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'phone')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'mobile')" class="table-cell">
...
<div v-if="Object.is(column.dataIndex, 'email')" class="table-cell">
