...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.example2name.visible" name="example2name" :rules="state.rules.example2name" :required="state.detailsModel.example2name.required" label="示例明细名称">
<appInput
  name="example2name"
  :disabled="state.detailsModel.example2name.disabled"
  :maxLength="200"
  type="text"
  :value="state.data.example2name"
