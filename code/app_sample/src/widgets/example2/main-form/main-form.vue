...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormGroup v-show="state.detailsModel.group1.visible" name="group1" title="示例明细基本信息">
    <a-row>
<a-col
  :lg="{span: 24, offset: 0 }"
  :md="{span: 24, offset: 0 }"
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <IbizFormItem v-show="state.detailsModel.example2name.visible" name="example2name" label="示例明细名称">
<IbizInput
  name="example2name"
  :maxLength="200"
  type="text"
