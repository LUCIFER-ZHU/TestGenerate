        ...
        <AppFormGroup 
          ...
          @componentEvent="onComponentEvent">
            <AppFormItem 
              ...
              :visible="state.detailsModel.opportunityname.visible" 
            ...
            <AppFormItem 
              ...
              :visible="state.detailsModel.exprevenue.visible" 
              :layoutOpts="{parentLayout: 'TABLE_24COL',colLG: 8,colMD: 8,colSM: 8,}"
              >
              <div class="form-editor-container" style="">
              <AppInput
                name="exprevenue"
            ...
            <AppFormItem 
              ...
              :visible="state.detailsModel.expendtime.visible" 
              :layoutOpts="{parentLayout: 'TABLE_24COL',colLG: 8,colMD: 8,colSM: 8,}"
              >
            ...
            <AppFormItem 
              ...
              :visible="state.detailsModel.priority.visible" 
              :layoutOpts="{parentLayout: 'TABLE_24COL',colLG: 8,colMD: 8,colSM: 8,}"
              >
              <div class="form-editor-container" style="">
              <AppDropdownList
            ...
            <AppFormItem 
              ...
              <AppDataPicker
                ...
                :context="state.context"
                :viewParams="state.viewParams"
                deMajorField="persondataname"
                deKeyField="persondataid"
                pickUpView="PersonDataPickupView"
