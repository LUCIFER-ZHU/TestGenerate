    ...
    <a-form name="grid" class="app-grid-form"  >
      ...
      >
        ...
        <template #headerCell="{title, column}">
          <div v-if="Object.is(column.dataIndex, 'cityname')" class="header-cell">
          ...
          <div v-if="Object.is(column.dataIndex, 'local')" class="header-cell">
          ...
          <div v-if="Object.is(column.dataIndex, 'provinceid')" class="header-cell">

              <span class="title">{{title}}</span>
            
          </div>
          <div v-if="Object.is(column.dataIndex, 'provincename')" class="header-cell">
        ...
        <template #bodyCell="{ column, text, record, index }">
          <div v-if="Object.is(column.dataIndex, 'cityname')" class="table-cell">
            <div class="text-cell">
          ...
          <div v-if="Object.is(column.dataIndex, 'local')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
          ...
          <div v-if="Object.is(column.dataIndex, 'provinceid')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
              
            </div>
          </div>
          <div v-if="Object.is(column.dataIndex, 'provincename')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
