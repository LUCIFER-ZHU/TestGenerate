...
import { CityService } from '@service/entity/city/city-service';
...
export class ControlVO extends ControlVOBase {
  ...
  constructor(data: any){
    super(data);
    // 记录没有映射的属性
    this.$ownKeys =['srfupdatedate','srforikey','srfkey','srfmajortext','srftempmode','srfuf','srfdeid','srfsourcekey','cityname','createman','createdate','updateman','updatedate','cityid'];  
  }
...
export const CtrlConfig = {
  ...
  controlName: 'form',
  controlService: new EditFormService<ControlVO>(ControlVO, new CityService() ),
  data: new ControlVO({}),
  formDetails: [
    {
      caption: '市基本信息',
