...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.cityname.visible" name="cityname" :rules="state.rules.cityname" :required="state.detailsModel.cityname.required" label="市名称">
<appInput
  name="cityname"
