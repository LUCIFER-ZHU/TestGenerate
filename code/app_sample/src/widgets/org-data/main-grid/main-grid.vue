    ...
    <a-form name="grid" class="app-grid-form"  >
      ...
      >
        ...
        <template #headerCell="{title, column}">
          <div v-if="Object.is(column.dataIndex, 'orgdataname')" class="header-cell">

              <span class="title">{{title}}</span>
            
          </div>
          <div v-if="Object.is(column.dataIndex, 'orgdatacode')" class="header-cell">

              <span class="title">{{title}}</span>
            
          </div>
          <div v-if="Object.is(column.dataIndex, 'porgdataname')" class="header-cell">
        ...
        <template #bodyCell="{ column, text, record, index }">
          <div v-if="Object.is(column.dataIndex, 'orgdataname')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
              
            </div>
          </div>
          <div v-if="Object.is(column.dataIndex, 'orgdatacode')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
              
            </div>
          </div>
          <div v-if="Object.is(column.dataIndex, 'porgdataname')" class="table-cell">
            <div class="text-cell">
              <span class="text">{{text}}</span>
