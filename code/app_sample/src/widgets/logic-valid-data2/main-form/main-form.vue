        ...
        <AppFormGroup 
          ...
          @componentEvent="onComponentEvent">
            <AppFormItem 
              ...
              :labelWidth="130"
              :showLabel="true"
              :rules="state.rules.region"
              :required="state.detailsModel.region.required"
              :visible="state.detailsModel.region.visible" 
            ...
            <AppFormItem 
              ...
              :required="state.detailsModel.code.required"
              :visible="state.detailsModel.code.visible" 
              :layoutOpts="{parentLayout: 'TABLE_24COL',colLG: 6,colMD: 8,colSM: 12,}"
              >
              <div class="form-editor-container" style="">
              <AppInput
            ...
            <AppFormItem 
              ...
              :labelWidth="130"
              :showLabel="true"
              :rules="state.rules.logicvaliddata2name"
              :required="state.detailsModel.logicvaliddata2name.required"
              :visible="state.detailsModel.logicvaliddata2name.visible" 
              :layoutOpts="{parentLayout: 'TABLE_24COL',colLG: 6,colMD: 8,colSM: 12,}"
              >
              <div class="form-editor-container" style="">
              <AppInput
