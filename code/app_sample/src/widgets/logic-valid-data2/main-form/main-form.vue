...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.region.visible" name="region" :rules="state.rules.region" :required="state.detailsModel.region.required" label="区域">
<appInput
  name="region"
  :disabled="state.detailsModel.region.disabled"
  :maxLength="100"
  type="text"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.code.visible" name="code" :rules="state.rules.code" :required="state.detailsModel.code.required" label="标识">
<appInput
  name="code"
  :disabled="state.detailsModel.code.disabled"
  :maxLength="100"
  type="text"
...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.logicvaliddata2name.visible" name="logicvaliddata2name" :rules="state.rules.logicvaliddata2name" :required="state.detailsModel.logicvaliddata2name.required" label="名称">
<appInput
  name="logicvaliddata2name"
  :disabled="state.detailsModel.logicvaliddata2name.disabled"
  :maxLength="200"
  type="text"
  :value="state.data.logicvaliddata2name"
  @editorEvent="onEditorEvent"
/> 
  </AppFormItem>
</a-col>
