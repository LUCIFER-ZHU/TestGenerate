...
<a-col
  ...
  :xs="{span: 24, offset: 0 }"
 >
  <AppFormItem v-show="state.detailsModel.logicvaliddataname.visible" name="logicvaliddataname" :required="state.detailsModel.logicvaliddataname.required" label="名称">
<appInput
