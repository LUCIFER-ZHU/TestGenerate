...
export class SampleVerServiceBase extends EntityService {
  ...
  /**
    ...
    * @memberof SampleVerServiceBase
    */
  async FetchJAVAR7D(context: any = {}, viewParams: any = {}): Promise<any> {
    let deResPath = this.buildDeResPath(context, false);
    const res = await this.http.post(deResPath+'/', viewParams);
    // TODO @executeafterbatchaction
    return res;
  ...
  /**
    ...
    * @memberof SampleVerServiceBase
    */
  async FetchMOBR7D(context: any = {}, viewParams: any = {}): Promise<any> {
    let deResPath = this.buildDeResPath(context, false);
    const res = await this.http.post(deResPath+'/', viewParams);
    // TODO @executeafterbatchaction
    return res;
  ...
  /**
    ...
    * @memberof SampleVerServiceBase
    */
  async FetchWEBR7D(context: any = {}, viewParams: any = {}): Promise<any> {
    let deResPath = this.buildDeResPath(context, false);
    const res = await this.http.post(deResPath+'/', viewParams);
    // TODO @executeafterbatchaction
    return res;
