...
export class UIServiceRegister implements IUIServiceRegister {
    ...
    protected init(): void {
        ...
        UIServiceRegister.allUIServiceMap.set('logicvaliddata', () => import('@ui-service/logic-valid-data/logic-valid-data-ui-service'));
        ...
        UIServiceRegister.allUIServiceMap.set('leaveapplication', () => import('@ui-service/leave-application/leave-application-ui-service'));
        UIServiceRegister.allUIServiceMap.set('logicvaliddata2', () => import('@ui-service/logic-valid-data2/logic-valid-data2-ui-service'));
