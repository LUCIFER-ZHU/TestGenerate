export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@2d0bfb24, net.ibizsys.model.app.view.PSAppViewUIActionImpl@c3fa05a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@7b44b63d, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4a699efa, net.ibizsys.model.app.view.PSAppViewUIActionImpl@38499e48, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4905c46b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@17ae7628, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1136b469, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6579c3d9, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2b87581, net.ibizsys.model.app.view.PSAppViewUIActionImpl@66434cc8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@42f22995, net.ibizsys.model.app.view.PSAppViewUIActionImpl@693e4d19, net.ibizsys.model.app.view.PSAppViewUIActionImpl@286b39c2]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
