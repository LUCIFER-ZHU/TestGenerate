export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@54dcbb9f, net.ibizsys.model.app.view.PSAppViewUIActionImpl@74fef3f7, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2a037324, net.ibizsys.model.app.view.PSAppViewUIActionImpl@69eb86b4, net.ibizsys.model.app.view.PSAppViewUIActionImpl@585ac855, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5bb8f9e2, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6a933be2, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5f78de22, net.ibizsys.model.app.view.PSAppViewUIActionImpl@516ebdf8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4d8539de, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3eba57a7, net.ibizsys.model.app.view.PSAppViewUIActionImpl@272a179c, net.ibizsys.model.app.view.PSAppViewUIActionImpl@30feffc, net.ibizsys.model.app.view.PSAppViewUIActionImpl@67207d8a]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
