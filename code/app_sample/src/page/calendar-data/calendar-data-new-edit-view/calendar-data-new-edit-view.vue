...
import { ViewConfig } from './calendar-data-new-edit-view-config';
import { NewForm } from '@widgets/calendar-data/new-form';
...
<template>
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <IbizToolbar
        :toolbarModel="state.neweditviewtoolbar"
      ...
      <NewForm
        ...
        :context="state.context"
        :viewParams="state.viewParams"
        :controlAction="state.controlsAction.New"
