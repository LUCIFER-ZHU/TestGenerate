export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@3bc735b3, net.ibizsys.model.app.view.PSAppViewUIActionImpl@577f9109, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4303b7f0, net.ibizsys.model.app.view.PSAppViewUIActionImpl@757529a4, net.ibizsys.model.app.view.PSAppViewUIActionImpl@779de014, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5c41d037, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2234078, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5ec77191, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4642b71d, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1450078a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@c68a5f8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@69c6161d, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3aefae67, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2e1792e7]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
