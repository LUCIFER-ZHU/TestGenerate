...
import { ViewConfig } from './product-pickup-view-config';
import { PickupViewpickupviewpanelPickUpViewPanel } from '@widgets/product/pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context: IContext;
  viewParams?: IParam;
