...
import { ViewConfig } from './org-data-pickup-view-config';
import { PickupViewpickupviewpanelPickUpViewPanel } from '@widgets/org-data/pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context: IContext;
  viewParams?: IParam;
