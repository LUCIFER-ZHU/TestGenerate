export const ViewConfig = {
  ...
  width: '0',
  viewMsgGroup: '',
  viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@1549bba7, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3e4f80cb, net.ibizsys.model.app.view.PSAppViewUIActionImpl@38704ff0, net.ibizsys.model.app.view.PSAppViewUIActionImpl@16ade133]',
  viewSysCss: '',
  viewSysImage: '',
  subCaption: '',
  viewType: 'DEGRIDVIEW',
