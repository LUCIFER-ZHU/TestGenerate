export const ViewConfig = {
  ...
  width: '0',
  viewMsgGroup: '',
  viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@2822c6ff, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4dafba3e, net.ibizsys.model.app.view.PSAppViewUIActionImpl@53e3a87a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@40368a46, net.ibizsys.model.app.view.PSAppViewUIActionImpl@7e9da981, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4ed38226, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3d43fe, net.ibizsys.model.app.view.PSAppViewUIActionImpl@74ad8d05, net.ibizsys.model.app.view.PSAppViewUIActionImpl@676ff3b0, net.ibizsys.model.app.view.PSAppViewUIActionImpl@35ff8fc9, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5fb7183b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@476a736d, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5f80fa43, net.ibizsys.model.app.view.PSAppViewUIActionImpl@16c8b7bd]',
  viewSysCss: '',
  viewSysImage: 'net.ibizsys.model.res.PSSysImageImpl@7159139f',
  subCaption: '',
  viewType: 'DEGRIDVIEW',
  viewStyle: 'DEFAULT',
