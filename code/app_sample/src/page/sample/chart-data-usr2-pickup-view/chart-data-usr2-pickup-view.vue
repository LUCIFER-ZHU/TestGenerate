...
import { ViewConfig } from './chart-data-usr2-pickup-view-config';
import { Usr2PickupViewpickupviewpanelPickUpViewPanel } from '@widgets/chart-data/usr2-pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context: IContext;
  viewParams?: IParam;
    ...
    <IbizPickerUpViewLayout class="ibiz-pickup-view">
        <template v-slot:header-left>
          <IbizIconText class="ibiz-view__caption" size="large" :text="state.viewCaption" />
            ...
            <Usr2PickupViewpickupviewpanelPickUpViewPanel
