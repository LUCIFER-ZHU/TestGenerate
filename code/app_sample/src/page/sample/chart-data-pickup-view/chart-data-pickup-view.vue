...
import { ViewConfig } from './chart-data-pickup-view-config';
import { PickupViewpickupviewpanelPickUpViewPanel } from '@widgets/chart-data/pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context: IContext;
  viewParams?: IParam;
