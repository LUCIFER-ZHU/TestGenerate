export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@5432050b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@75f2099, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1c12f3ee, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6d467c87, net.ibizsys.model.app.view.PSAppViewUIActionImpl@29182679, net.ibizsys.model.app.view.PSAppViewUIActionImpl@57bd802b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5cbb84b1, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2c779e5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6a84bc2a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5183d589, net.ibizsys.model.app.view.PSAppViewUIActionImpl@511d5d04, net.ibizsys.model.app.view.PSAppViewUIActionImpl@682c1e93, net.ibizsys.model.app.view.PSAppViewUIActionImpl@27068a50, net.ibizsys.model.app.view.PSAppViewUIActionImpl@68e62ca4]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
