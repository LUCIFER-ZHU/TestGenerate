...
import { ViewConfig } from './province-tree-nav-info-edit-view-config';
import { TreeNavInfoForm } from '@widgets/province/tree-nav-info-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <TreeNavInfoForm
        ...
        :controlAction="state.controlsAction.TreeNavInfo"
