export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@51745f40, net.ibizsys.model.app.view.PSAppViewUIActionImpl@45673f68, net.ibizsys.model.app.view.PSAppViewUIActionImpl@27abb83e, net.ibizsys.model.app.view.PSAppViewUIActionImpl@69e308c6, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1a1ed4e5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@667e34b1, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1c6e0a08, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6dba847b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1efdcd5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1623bbe5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@7af1cd63, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4351171a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3c2772d1, net.ibizsys.model.app.view.PSAppViewUIActionImpl@37d00a23]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
