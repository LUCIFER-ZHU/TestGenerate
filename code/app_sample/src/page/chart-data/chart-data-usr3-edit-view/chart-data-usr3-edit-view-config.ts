export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@278f8425, net.ibizsys.model.app.view.PSAppViewUIActionImpl@695a69a1, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4b1abd11, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3f36b447, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6443b128, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5eeedb60, net.ibizsys.model.app.view.PSAppViewUIActionImpl@40021799, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4a1c0752, net.ibizsys.model.app.view.PSAppViewUIActionImpl@332f25c8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1b32cd16, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4bdcaf36, net.ibizsys.model.app.view.PSAppViewUIActionImpl@61d01788, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2b9b7f1f, net.ibizsys.model.app.view.PSAppViewUIActionImpl@264c5d07]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
