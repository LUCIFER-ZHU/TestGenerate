...
import { ViewConfig } from './chart-data-usr2-edit-view-config';
import { EmbeddedviewForm } from '@widgets/chart-data/embeddedview-form';
...
<template>
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <IbizToolbar
        :toolbarModel="state.usr2editviewtoolbar"
      ...
      <EmbeddedviewForm
        ...
        :context="state.context"
        :viewParams="state.viewParams"
        :controlAction="state.controlsAction.Embeddedview"
