export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@400d912a, net.ibizsys.model.app.view.PSAppViewUIActionImpl@9f6e406, net.ibizsys.model.app.view.PSAppViewUIActionImpl@7a94b64e, net.ibizsys.model.app.view.PSAppViewUIActionImpl@3e6f3bae, net.ibizsys.model.app.view.PSAppViewUIActionImpl@12477988, net.ibizsys.model.app.view.PSAppViewUIActionImpl@2caf6912, net.ibizsys.model.app.view.PSAppViewUIActionImpl@73d69c0f, net.ibizsys.model.app.view.PSAppViewUIActionImpl@34237b90, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1d01dfa5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4a31c2ee, net.ibizsys.model.app.view.PSAppViewUIActionImpl@d400943, net.ibizsys.model.app.view.PSAppViewUIActionImpl@22101c80, net.ibizsys.model.app.view.PSAppViewUIActionImpl@31ff1390, net.ibizsys.model.app.view.PSAppViewUIActionImpl@759d81f3]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
    ...
    showCaptionBar: 'DEFAULT',
        ...
        items:[
            ...
            { name:'tbitem9_saveandstart',caption:'提交流程',groupExtractMode:'ITEM',itemType:'DEUIACTION',noPrivDisplayMode:'2',showIcon:true,showCaption:true,tooltip:'提交流程' },
            { name:'tbitem10',caption:'当前流程步骤',groupExtractMode:'ITEM',itemType:'DEUIACTION',noPrivDisplayMode:'2',showIcon:true,showCaption:true,tooltip:'当前流程步骤' },
            { name:'tbitem11',caption:'',groupExtractMode:'',itemType:'SEPERATOR',noPrivDisplayMode:'',showIcon:false,showCaption:false,tooltip:'' },
