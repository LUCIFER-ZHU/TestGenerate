...
import { ViewConfig } from './example-nav-param-edit-view-config';
import { NavParamForm } from '@widgets/example/nav-param-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <NavParamForm
        ...
        :controlAction="state.controlsAction.NavParam"
