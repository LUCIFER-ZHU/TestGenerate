...
import { ViewConfig } from './example-pickup-view-edit-view-config';
import { PickupViewForm } from '@widgets/example/pickup-view-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <PickupViewForm
        ...
        :controlAction="state.controlsAction.PickupView"
