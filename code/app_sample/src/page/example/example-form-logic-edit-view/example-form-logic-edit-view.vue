...
import { ViewConfig } from './example-form-logic-edit-view-config';
import { FormLogicForm } from '@widgets/example/form-logic-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <FormLogicForm
        ...
        :controlAction="state.controlsAction.FormLogic"
