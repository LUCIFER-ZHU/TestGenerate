...
import { ViewConfig } from './example-auto-complete-edit-view-config';
import { AutoCompleteForm } from '@widgets/example/auto-complete-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <AutoCompleteForm
        ...
        :controlAction="state.controlsAction.AutoComplete"
