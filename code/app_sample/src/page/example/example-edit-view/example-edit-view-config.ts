export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@773bd77b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6b580b88, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6d91790b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6e6fce47, net.ibizsys.model.app.view.PSAppViewUIActionImpl@47c64cfe, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6ce90bc5, net.ibizsys.model.app.view.PSAppViewUIActionImpl@a567e72, net.ibizsys.model.app.view.PSAppViewUIActionImpl@1a5b8489, net.ibizsys.model.app.view.PSAppViewUIActionImpl@6f8f8a80, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4b1c0397, net.ibizsys.model.app.view.PSAppViewUIActionImpl@72805168, net.ibizsys.model.app.view.PSAppViewUIActionImpl@34b9fc7d, net.ibizsys.model.app.view.PSAppViewUIActionImpl@27f1bbe0, net.ibizsys.model.app.view.PSAppViewUIActionImpl@cda0432]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
