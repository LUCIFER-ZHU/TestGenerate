...
import { ViewConfig } from './example-ui-logic-edit-view-config';
import { UILogicForm } from '@widgets/example/ui-logic-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <UILogicForm
        ...
        :controlAction="state.controlsAction.UILogic"
