...
import { ViewConfig } from './example-form-adv-group-edit-view-config';
import { AdvGroupForm } from '@widgets/example/adv-group-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <AdvGroupForm
        ...
        :controlAction="state.controlsAction.AdvGroup"
