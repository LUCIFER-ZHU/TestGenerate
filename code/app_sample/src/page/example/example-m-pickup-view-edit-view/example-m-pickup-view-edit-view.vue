...
import { ViewConfig } from './example-m-pickup-view-edit-view-config';
import { MPickupViewForm } from '@widgets/example/m-pickup-view-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <MPickupViewForm
        ...
        :controlAction="state.controlsAction.MPickupView"
