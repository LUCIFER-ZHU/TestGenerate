...
import { ViewConfig } from './example-form-value-format-edit-view-config';
import { ValueFormatForm } from '@widgets/example/value-format-form';
  ...
  <IbizDefaultViewLayout :class="['ibiz-edit-view', state.viewSysCss]">
    <template v-slot:header-left>
      ...
      <ValueFormatForm
        ...
        :controlAction="state.controlsAction.ValueFormat"
