export const ViewConfig = {
    ...
    width: '0',
    viewMsgGroup: '',
    viewUIActions: '[net.ibizsys.model.app.view.PSAppViewUIActionImpl@49096b06, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4a183d02, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5d05ef57, net.ibizsys.model.app.view.PSAppViewUIActionImpl@213deac2, net.ibizsys.model.app.view.PSAppViewUIActionImpl@23eee4b8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@28952dea, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5a9800f8, net.ibizsys.model.app.view.PSAppViewUIActionImpl@143d9a93, net.ibizsys.model.app.view.PSAppViewUIActionImpl@40226788, net.ibizsys.model.app.view.PSAppViewUIActionImpl@4159e81b, net.ibizsys.model.app.view.PSAppViewUIActionImpl@5b5caf08, net.ibizsys.model.app.view.PSAppViewUIActionImpl@23cd4ff2, net.ibizsys.model.app.view.PSAppViewUIActionImpl@70807224, net.ibizsys.model.app.view.PSAppViewUIActionImpl@7e97551f]',
    viewSysCss: '',
    viewSysImage: '',
    subCaption: '',
    viewType: 'DEEDITVIEW',
