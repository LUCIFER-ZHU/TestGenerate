...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("@views/sample/editor-value-row-edit-grid-view"),
      },
      {
      ...
      {
        path: "orgdatas/:orgdata?/orgdatas/:orgdata?/views/orgdataorgdeptdatatreeview",
        meta: {
          tag:'OrgDataOrgDeptDataTreeView'
        },
        component: () => import("@views/sample/org-data-org-dept-data-tree-view"),
      },
      {
      ...
      {
        path: "provinces/:province?/cities/:city?/views/cityusr2gridview",
        meta: {
          tag:'CityUsr2GridView'
        },
        component: () => import("@views/sample/city-usr2-grid-view"),
      },
      {
      ...
      {
        path: "examples/:example?/views/examplecssandicontreeview",
        meta: {
          tag:'ExampleCssAndIconTreeView'
        },
        component: () => import("@views/sample/example-css-and-icon-tree-view"),
      },
      {
      ...
      {
        path: "examples/:example?/views/exampledatasourcetreeview",
        meta: {
          tag:'ExampleDataSourceTreeView'
        },
        component: () => import("@views/sample/example-data-source-tree-view"),
      },
      {
      ...
      {
        path: "examples/:example?/views/examplerightclicktreeview",
        meta: {
          tag:'ExampleRightClickTreeView'
        },
        component: () => import("@views/sample/example-right-click-tree-view"),
      },
      {
      ...
      {
        path: "examples/:example?/views/exampledatasourceadvtreeview",
        meta: {
          tag:'ExampleDataSourceAdvTreeView'
        },
        component: () => import("@views/sample/example-data-source-adv-tree-view"),
      },
      {
      ...
      {
        path: "examples/:example?/views/examplesearchtreeview",
        meta: {
          tag:'ExampleSearchTreeView'
        },
        component: () => import("@views/sample/example-search-tree-view"),
      },
      {
      ...
      {
        path: "customers/:customer?/views/customermaintabexpview",
        meta: {
          tag:'CustomerMainTabExpView'
        },
        component: () => import("@views/sample/customer-main-tab-exp-view"),
      },
      {
      ...
      {
        path: "chartdatas/:chartdata?/views/chartdatatreeview",
        meta: {
          tag:'ChartDataTreeView'
        },
        component: () => import("@views/sample/chart-data-tree-view"),
      },
      {
      ...
      {
        path: "chartdatas/:chartdata?/views/chartdatatabexpview",
        meta: {
          tag:'ChartDataTabExpView'
        },
        component: () => import("@views/sample/chart-data-tab-exp-view"),
      },
      {
      ...
      {
        path: "views/counterappindexview",
        meta: {
            tag:'CounterAppIndexView'
        },
        component: () => import("@views/sample/counter-app-index-view"),
      },
      {
        path: "views/appfuncappindexview",
        meta: {
            tag:'AppFuncAppIndexView'
        },
        component: () => import("@views/sample/app-func-app-index-view"),
      },
      {
        path: "views/editortypeindexview",
        meta: {
            tag:'EditorTypeIndexView'
        },
        component: () => import("@views/sample/editor-type-index-view"),
      },
      {
        path: "views/appglobalappindexview",
        meta: {
            tag:'AppGlobalAppIndexView'
        },
        component: () => import("@views/sample/app-global-app-index-view"),
      },
      {
        ...
        component: () => import("@views/sample/app-portal-view"),
      },
      {
        path: "views/viewtypeindexview",
        meta: {
