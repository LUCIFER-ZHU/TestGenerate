...
import { viewState } from './customer-edit-view-misc-tree-exp-view-state';
import { EditViewMiscTreeExpViewtreeexpbarTreeExpBar } from '@widgets/customer/edit-view-misc-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <EditViewMiscTreeExpViewtreeexpbarTreeExpBar
