...
import { viewState } from './wizard-data-grid-view-state';
import { MainGrid } from '@widgets/wizard-data/main-grid';
import { DefaultSearchForm } from '@widgets/wizard-data/default-search-form';
