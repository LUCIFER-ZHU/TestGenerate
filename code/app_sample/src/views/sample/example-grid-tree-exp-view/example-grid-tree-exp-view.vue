...
import { viewState } from './example-grid-tree-exp-view-state';
import { GridTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/grid-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <GridTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
