...
import { viewState } from './province-grid-data-view-state';
import { MainGrid } from '@widgets/province/main-grid';
import { DefaultSearchForm } from '@widgets/province/default-search-form';
