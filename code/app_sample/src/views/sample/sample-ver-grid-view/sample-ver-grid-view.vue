...
import { viewState } from './sample-ver-grid-view-state';
import { MainGrid } from '@widgets/sample-ver/main-grid';
import { DefaultSearchForm } from '@widgets/sample-ver/default-search-form';
