...
import { viewState } from './chart-data-tree-exp-view-state';
import { TreeExpViewtreeexpbarTreeExpBar } from '@widgets/chart-data/tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <TreeExpViewtreeexpbarTreeExpBar
