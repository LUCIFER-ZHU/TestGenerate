...
import { viewState } from './dept-data-pickup-view-state';
import { PickupViewpickupviewpanelPickUpViewPanel } from '@widgets/dept-data/pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context: IContext;
  viewParams?: IParam;
