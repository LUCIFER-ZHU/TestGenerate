...
import { viewState } from './counter-data2-grid-view-state';
import { MainGrid } from '@widgets/counter-data2/main-grid';
import { DefaultSearchForm } from '@widgets/counter-data2/default-search-form';
