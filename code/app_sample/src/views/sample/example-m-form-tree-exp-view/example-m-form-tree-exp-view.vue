...
import { viewState } from './example-m-form-tree-exp-view-state';
import { MFormTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/m-form-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <MFormTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
