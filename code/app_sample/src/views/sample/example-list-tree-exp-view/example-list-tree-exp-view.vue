...
import { viewState } from './example-list-tree-exp-view-state';
import { ListTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/list-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <ListTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
