...
import { viewState } from './customer-auto-search-grid-view-state';
import { MainGrid } from '@widgets/customer/main-grid';
import { AutoSearchSearchForm } from '@widgets/customer/auto-search-search-form';
