...
import { viewState } from './order-m-pickup-view-state';
import { MPickupViewpickupviewpanelPickupViewPanel } from '@widgets/order/m-pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context?: IContext;
  viewParams?: IParam;
