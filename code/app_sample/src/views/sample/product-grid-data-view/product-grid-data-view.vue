...
import { viewState } from './product-grid-data-view-state';
import { MainGrid } from '@widgets/product/main-grid';
import { DefaultSearchForm } from '@widgets/product/default-search-form';
