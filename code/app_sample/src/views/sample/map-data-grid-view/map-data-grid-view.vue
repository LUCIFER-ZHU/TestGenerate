...
import { viewState } from './map-data-grid-view-state';
import { MainGrid } from '@widgets/map-data/main-grid';
import { DefaultSearchForm } from '@widgets/map-data/default-search-form';
