...
import { viewState } from './example-ui-logic-tree-exp-view-state';
import { UILogicTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/ui-logic-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <UILogicTreeExpViewtreeexpbarTreeExpBar
