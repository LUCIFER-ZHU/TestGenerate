...
import { viewState } from './example-tool-bar-tree-exp-view-state';
import { ToolBarTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/tool-bar-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <ToolBarTreeExpViewtreeexpbarTreeExpBar
