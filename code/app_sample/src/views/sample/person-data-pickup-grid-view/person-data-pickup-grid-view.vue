...
import { viewState } from './person-data-pickup-grid-view-state';
import { MainGrid } from '@widgets/person-data/main-grid';
import { DefaultSearchForm } from '@widgets/person-data/default-search-form';
