...
import { viewState } from './order-detail-grid-view-state';
import { MainGrid } from '@widgets/order-detail/main-grid';
import { DefaultSearchForm } from '@widgets/order-detail/default-search-form';
