...
import { viewState } from './example-form-tree-exp-view-state';
import { FormTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/form-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <FormTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
