...
import { viewState } from './kanban-data-grid-view-state';
import { MainGrid } from '@widgets/kanban-data/main-grid';
import { DefaultSearchForm } from '@widgets/kanban-data/default-search-form';
