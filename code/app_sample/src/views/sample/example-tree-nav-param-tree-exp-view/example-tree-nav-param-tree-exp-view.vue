...
import { viewState } from './example-tree-nav-param-tree-exp-view-state';
import { TreeNavParamTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/tree-nav-param-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <TreeNavParamTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
