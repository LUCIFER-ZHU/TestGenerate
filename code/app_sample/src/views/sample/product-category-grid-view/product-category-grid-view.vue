...
import { viewState } from './product-category-grid-view-state';
import { MainGrid } from '@widgets/product-category/main-grid';
import { DefaultSearchForm } from '@widgets/product-category/default-search-form';
