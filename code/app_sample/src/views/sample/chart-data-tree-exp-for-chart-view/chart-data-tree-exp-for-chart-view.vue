...
import { viewState } from './chart-data-tree-exp-for-chart-view-state';
import { TreeExpForChartViewtreeexpbarTreeExpBar } from '@widgets/chart-data/tree-exp-for-chart-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <TreeExpForChartViewtreeexpbarTreeExpBar
        name="treeexpbar"
