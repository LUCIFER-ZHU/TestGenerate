...
import { viewState } from './example-dashboard-tree-exp-view-state';
import { DashboardTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/dashboard-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <DashboardTreeExpViewtreeexpbarTreeExpBar
