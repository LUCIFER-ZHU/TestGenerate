...
import { viewState } from './dept-data-grid-view-state';
import { MainGrid } from '@widgets/dept-data/main-grid';
import { DefaultSearchForm } from '@widgets/dept-data/default-search-form';
