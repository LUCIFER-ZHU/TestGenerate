...
import { viewState } from './customer-m-pickup-view-state';
import { MPickupViewpickupviewpanelPickupViewPanel } from '@widgets/customer/m-pickup-viewpickupviewpanel-pickup-view-panel';
// props声明和默认值处理
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppMpickupViewLayout :class="['app-mpickup-view', state.viewSysCss]">
      ...
      <a-row class="app-mpickup-view__split">
        <a-col :span="18">
            <MPickupViewpickupviewpanelPickupViewPanel
