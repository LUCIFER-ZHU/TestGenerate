...
import { viewState } from './example-search-bar-tree-exp-view-state';
import { SearchBarTreeExpViewtreeexpbarTreeExpBar } from '@widgets/example/search-bar-tree-exp-viewtreeexpbar-tree-exp-bar';
interface Props {
  context?: IContext;
  viewParams?: IParam;
...
<template>
    <AppTreeExpViewLayout :class="['app-tree-exp-view', state.viewSysCss]">
      ...
      <SearchBarTreeExpViewtreeexpbarTreeExpBar
        name="treeexpbar"
