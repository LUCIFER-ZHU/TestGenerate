...
import { viewState } from './example2-grid-view-state';
import { MainGrid } from '@widgets/example2/main-grid';
import { DefaultSearchForm } from '@widgets/example2/default-search-form';
