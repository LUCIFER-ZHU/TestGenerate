...
import { viewState } from './activity-grid-view-state';
import { MainGrid } from '@widgets/activity/main-grid';
import { DefaultSearchForm } from '@widgets/activity/default-search-form';
