...
export class LeaveApplicationServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of LeaveApplicationServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof LeaveApplicationServiceBase
  */
  constructor(opts: IParam = {}) {
      super(opts,'LeaveApplication');
  }
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'leaveapplication';
    this.appEntityCodeNames = 'leaveapplications';
    this.appEntityKeyCodeName = 'leaveapplicationid';
      this.appEntityTextCodeName = 'leaveapplicationname';
    // 初始化关系实体路径集合
    this.deResPaths = [
    ...
    /**
      ...
      * @memberof LeaveApplicationServiceBase
      */
    public async A(context: IContext = {}, data: IParam = {}): Promise<any> {
      const deResPath = this.buildDeResPath(context, true);
      this.beforeExecuteAction(context,data,'A');
      const res = await this.http.post(`${deResPath}/a`,data);
      this.afterExecuteAction(context,data,'A');
      return res;
    }
    /**
      * CheckKey
