...
export class EditorValueServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of EditorValueServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof EditorValueServiceBase
  */
  constructor(opts: IParam = {}) {
      super(opts,'EditorValue');
  }
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'editorvalue';
    this.appEntityCodeNames = 'editorvalues';
    this.appEntityKeyCodeName = 'editorvalueid';
      this.appEntityTextCodeName = 'editorvaluename';
    // 初始化关系实体路径集合
    this.deResPaths = [
