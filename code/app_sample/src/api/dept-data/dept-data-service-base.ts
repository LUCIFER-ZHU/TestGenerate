...
export class DeptDataServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of DeptDataServiceBase.
  *
  * @param {*} [opts={}]
  ...
  */
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'deptdata';
    this.appEntityCodeNames = 'deptdatas';
    this.appEntityKeyCodeName = 'deptdataid';
      this.appEntityTextCodeName = 'deptdataname';
    // 初始化关系实体路径集合
    this.deResPaths = [
