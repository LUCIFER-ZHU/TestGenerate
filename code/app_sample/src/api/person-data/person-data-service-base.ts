...
export class PersonDataServiceBase extends EntityService {
  ...
  /**
  * Creates an instance of PersonDataServiceBase.
  *
  * @param {*} [opts={}]
  * @memberof PersonDataServiceBase
  */
  constructor(opts: IParam = {}) {
      super(opts,'PersonData');
  }
  ...
  protected initBasicData() {
    this.appEntityCodeName = 'persondata';
    this.appEntityCodeNames = 'peopledata';
    this.appEntityKeyCodeName = 'persondataid';
      this.appEntityTextCodeName = 'persondataname';
    // 初始化关系实体路径集合
    this.deResPaths = [
