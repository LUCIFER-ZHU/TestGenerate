...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AppCodelist: typeof import('./src/components/common/app-codelist.vue')['default']
    AppCol: typeof import('./src/components/common/app-col.vue')['default']
    AppColumnLink: typeof import('./src/components/common/app-column-link.vue')['default']
    ...
    AppFormButton: typeof import('./src/components/common/app-form-button.vue')['default']
    ...
    AppFormIframe: typeof import('./src/components/common/app-form-iframe.vue')['default']
    AppFormItem: typeof import('./src/components/common/app-form-item.vue')['default']
    AppFormPage: typeof import('./src/components/common/app-form-page.vue')['default']
    AppFormRaw: typeof import('./src/components/common/app-form-raw.vue')['default']
    AppFormTabpage: typeof import('./src/components/common/app-form-tabpage.vue')['default']
    AppFormTabPage: typeof import('./src/components/common/app-form-tab-page.vue')['default']
    AppFormTabpanel: typeof import('./src/components/common/app-form-tabpanel.vue')['default']
    AppFormTabPanel: typeof import('./src/components/common/app-form-tab-panel.vue')['default']
    ...
    AppPortletCard: typeof import('./src/components/common/app-portlet-card.vue')['default']
    ...
    AppRow: typeof import('./src/components/common/app-row.vue')['default']
